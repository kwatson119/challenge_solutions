...
function addFriend(userhandle, friendhandle) {
  ...
  return 
    let user = /* filter the users array on db_data for the userhandle */
    let friend =  /* filter the users array on db_data for the friendhandle */
    
    if(/*figure out the conditional to test if we didn't find the user or the friend*/) {
